...
```{r}
print(result)
write.table(result, paste('classification_one_vs_all_gglasso_', toString(oversample.p), '_', toString(lambda.factor), '.csv', sep = ''), sep = ',', row.names = F)

colnames(result_coefs) = label
print(result_coefs)
write.csv(result_coefs, paste('classification_coefs_one_vs_all_gglasso_', toString(oversample.p), '_', toString(lambda.factor), '.csv', sep = ''), row.names = T)
```
...
```{r}
print(result)
write.table(result, paste('classification_one_vs_all_lasso_', toString(oversample.p), '.csv', sep = ''), sep = ',', row.names = F)

colnames(result_coefs) = label
print(result_coefs)
write.csv(result_coefs, paste('classification_one_vs_all_coefs_lasso_', toString(oversample.p), '.csv', sep = ''), row.names = T)
```
